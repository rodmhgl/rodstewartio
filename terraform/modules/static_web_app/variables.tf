...
variable "resource_group_name" {
  type        = string
  description = "The name of the resource group in which the Static Web App should be created."

}

variable "location" {
  type        = string
  description = "The Azure Region where the Static Web App should be created. Changing this forces a new Static Web App to be created."
  default     = "eastus2"
}
